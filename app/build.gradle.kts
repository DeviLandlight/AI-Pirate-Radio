...
android {
    namespace = "com.aipirateradio.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.aipirateradio.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
        ...
        resValue("string", "openai_tts_model", localProperties.getProperty("openai.ttsModel", "gpt-4o-mini-tts"))
    }
